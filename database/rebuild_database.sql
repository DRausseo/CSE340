...
-- Asegurarse de que estas dos consultas sean lo último que se ejecute
-- Consulta 4: Modificar el registro 'GM Hummer' para cambiar la descripción
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Consulta 6: Actualizar todos los registros en la tabla 'inventory' para agregar '/vehicles'
UPDATE public.inventory
